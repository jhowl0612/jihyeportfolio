...
(function(w) {
    ...
    try {
        var links = ["https:\/\/\/\/idsync.admixer.co.kr:4450\/idsync?pid=102&uid=ce68d6ea01f2e15427a8bc2b9b56f326","\/\/analytics.ad.daum.net\/match?d=106&uid=ce68d6ea01f2e15427a8bc2b9b56f326"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
